...
const ProjectCard: React.FC<ProjectCardProps> = ({ image, title, desc, techStack, codeLink, siteLink }) => {
    return (
        <div className='w-80 min-h-127 bg-[#f6f6f694] dark:bg-[#202020] border border-gray-200 dark:border-black rounded-xl px-4 py-6 flex flex-col justify-between hover:scale-105 duration-200 shadow-md'>
