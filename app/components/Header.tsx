...
const Header: React.FC = () => {
    return (
        <div id='home' className='h-screen flex flex-col gap-6 items-center justify-center pt-5'>
            ...
            <div className='font-ct flex flex-col gap-2'>
                <h3 className='text-lg md:text-xl'>Hi, I&apos;m</h3>
                <h1 className='text-3xl md:text-5xl'>Varshith Pilli</h1>
            </div>

            <div>
                <h3 className='font-mw text-sm md:text-lg px-7'>I&apos;m a Comp Sci tech enthusiast who loves tweaking everything to figure things out.</h3>
                <h3 className='font-mw text-sm md:text-lg px-7'> I also enjoy building, exploring, and pushing the limits of technology!</h3>
